...
{
    /// <inheritdoc />
    public partial class AddModelTablesToHFDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeFacilities",
                columns: table => new
                {
                    EmployeeFacilityId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeFacilities", x => x.EmployeeFacilityId);
                });
